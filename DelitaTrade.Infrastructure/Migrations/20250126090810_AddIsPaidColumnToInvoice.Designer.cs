...
namespace DelitaTrade.Infrastructure.Migrations
{
    ...
    [Migration("20250126090810_AddIsPaidColumnToInvoice")]
    partial class AddIsPaidColumnToInvoice
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DelitaTrade.Infrastructure.Data.Models.DayReport", b =>
                {
                    ...
                    b.OwnsOne("System.Collections.Generic.Dictionary<decimal, int>", "Banknotes", b1 =>
                        {
                            b1.Property<int>("DayReportId")
                                .HasColumnType("int");

                            b1.HasKey("DayReportId");

                            b1.ToTable("DayReports");
