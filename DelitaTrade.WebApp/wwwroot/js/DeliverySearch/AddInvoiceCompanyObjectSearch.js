...
function onItemClick(event) {
    ...
    const itemIsBankPay = event.target.dataset.itemIsBankPay;
    ...
    const inputIsBankPayElement = document.querySelector('#item-is-bank-pay');
    inputIsBankPayElement.value = itemIsBankPay;
